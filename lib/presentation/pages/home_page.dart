...
import 'package:dars1_local_notification/presentation/widgets/action_buttons.dart';
import 'package:dars1_local_notification/presentation/widgets/custom_day_picker.dart';
import 'package:dars1_local_notification/presentation/widgets/date_field.dart';
import 'package:dars1_local_notification/presentation/widgets/header.dart';
import 'package:dars1_local_notification/presentation/widgets/time_field.dart';
import 'package:dars1_local_notification/services/notification_service.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> onCreate() async {
    ...
    if(eventDate == null || eventTime == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please choose date and time'),
